...
function readReports() { try { return JSON.parse(localStorage.getItem(REPORTS_KEY) || "[]"); } catch { return []; } }
function writeReports(r) { localStorage.setItem(REPORTS_KEY, JSON.stringify(r)); }
...
export default function AnalystDashboard() {
    ...
    const saveSnapshot = () => {
        const r = { id: crypto.randomUUID(), createdAt: Date.now(), summary: `Snapshot on ${new Date().toLocaleString()}` };
